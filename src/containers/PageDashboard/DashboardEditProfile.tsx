  ...
  useEffect(()=>{
    if(profile){
      setInitialValues({ email: profile.email || '', firstName: profile.firstName || '', 
        ...
        location: profile.location || '', avatar: '', coverPhoto: '', bgImage: profile.bgImage || '',
            ...
            <div className="block md:col-span-2">
              ...
              <div className="relative container -mt-20 lg:-mt-15">
                ...
                <div className="relative rounded-full overflow-hidden flex">
                  ...
                  <input name='avatar' onChange={(e) => setFieldValue(e.target.name, e.target.files[0])} type="file" className="absolute inset-0 opacity-0 cursor-pointer" />
                </div>
              </div>
              </div>
            </div>
